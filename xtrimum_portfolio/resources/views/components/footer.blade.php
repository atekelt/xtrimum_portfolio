        ...
        {{-- <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              <li><a href="files/Atekelt Afework CV 2025.pdf" download target="_blank" class="py-2 d-block">Portfolio</a></li>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="{{ url('/our_work') }}" class="py-2 d-block">Work</a></li>
            ...
            <div class="block-23 mb-3">
              <ul>
                <li>
                  ...
                  <span class="text">Ayat 49, Addis Ababa, Ethiopia</span>
                </li>
                <li>
                  <a href="tel:+251966351977">
                    <span class="icon icon-phone"></span>
                    <span class="text">+251 966 351 977</span>
                  </a>
                </li>
                <li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <a href="#" target="_blank">Xtrimum Solution</a>
